...
MuonTMVA::MuonTMVA(const edm::ParameterSet& iConfig)
{
  ...
  string dummy[] = { "muonPt", "muonEta", "muonPhi", "isGlobalMuon", "isPFMuon", "normalizedChi2", "chi2LocalPosition", "trkKink", "segmentCompatibility", "numberOfValidMuonHits", "numberOfMatchedStations", "pv0pos_dxy", "pv0pos_dz", "numberOfValidPixelHits", "trackerLayersWithMeasurement" };
